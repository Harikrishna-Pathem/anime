    ...
    <>
      ...
      <div className={`navbar2 ${menuOpen ? "open" : ""}`}>
        ...
        <div className="pincode">
          ...
          <input id="pincode" type="text" placeholder="Check delivery status" />
        </div>
      </div>
    </>
  );
